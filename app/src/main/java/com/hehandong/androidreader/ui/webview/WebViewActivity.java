package com.hehandong.androidreader.ui.webview;
...
import com.hehandong.androidreader.ui.webview.config.FullscreenHolder;
...
import com.hehandong.androidreader.utils.ShareUtils;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.actionbar_share:
                // 分享到
                String shareText = mTitle + webView.getUrl() + " (分享自AndroidReader)";
