package com.hehandong.androidreader.ui.webview.config;
...
import com.hehandong.androidreader.utils.BaseTools;
import com.hehandong.androidreader.utils.CheckNetwork;
...
public class MyWebViewClient extends WebViewClient {
    ...
    public MyWebViewClient(FragmentActivity activity, IWebPageView mIWebPageView) {
...
//        DebugUtil.error("----url:"+url);
     ...
     * 网页里可能唤起其他的app
     */
    private void handleOtherwise(FragmentActivity activity, String url) {
    ...
    private void startActivity(FragmentActivity activity, String url) {
        try {
