package com.hehandong.androidreader.utils;
...
import com.hehandong.androidreader.ui.CustomApplication;
...
public class BaseTools {
    ...
    public static String getVersionName() {
        ...
        try {
            packInfo = packageManager.getPackageInfo(CustomApplication.getInstance().getPackageName(), 0);
    ...
    public static void copy(String content) {
        if (!TextUtils.isEmpty(content)) {
            // 得到剪贴板管理器
            ClipboardManager cmb = (ClipboardManager) CustomApplication.getInstance().getSystemService(Context.CLIPBOARD_SERVICE);
    ...
    public static String getClipContent() {
        ClipboardManager manager = (ClipboardManager) CustomApplication.getInstance().getSystemService(Context.CLIPBOARD_SERVICE);
        if (manager != null) {
