...
import com.hehandong.androidreader.utils.SpannableStringUtils;
...
public class PullToRefreshAdapter extends BaseQuickAdapter<Status, BaseViewHolder> {
    ...
    ClickableSpan clickableSpan = new ClickableSpan() {
        ...
        public void onClick(View widget) {
            ToastUtil.showToastLong("事件触发了 landscapes and nedes");
        }

        @Override
        public void updateDrawState(TextPaint ds) {
            ds.setColor(CustomApplication.getInstance().getResources().getColor(R.color.clickspan_color));
